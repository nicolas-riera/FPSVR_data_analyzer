...
class GraphUI(ctk.CTkFrame):
    def __init__(self, master, headers, data, on_back, label):
        ...
        self.title_label = ctk.CTkLabel(self.container, text=label, font=("Roboto", 18, "bold"), anchor="center", text_color="white")
        self.title_label.grid(row=0, column=0, pady=(0, 15), sticky="ew")

        self.table_wrapper = ctk.CTkFrame(self.container, fg_color="#2b2b2b", corner_radius=15)
